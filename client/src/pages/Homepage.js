...
const Homepage = () => {
    ...
    const getTotal = async () => {
        try {
            const response = await axios.get('/products/product-count')
    ...
    const getAllproducts = async () => {
        try {
            setLoading(true)
            const response = await axios.get(`/products/product-list/${page}`)
            setLoading(false)
            if (response.data.success) {
    ...
    const filterProducts = async () => {
        try {
            const response = await axios.post('/products/filter-products', { checked, radio })
            if (response.data.success) {
                setProducts(response.data?.products)
            }
        } catch (error) {
