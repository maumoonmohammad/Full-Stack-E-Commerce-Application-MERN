...
const ProductDetails = () => {
    ...
    const getSimilarProducts = async (pid, cid) => {
        try {
            const resposne = await axios.get(`https://impossible-ray-headscarf.cyclic.app/products/related-products/${pid}/${cid}`)
    ...
    const getProduct = async () => {
        try {
            ...
            const resposne = await axios.get(`https://impossible-ray-headscarf.cyclic.app/products/single-product/${params.slug}`)
        ...
        <Layout>
            <div className="row container mt-2">
                <div className="col-md-6">
                    <img
                        src={`https://impossible-ray-headscarf.cyclic.app/products/product-photo/${product._id}`}
