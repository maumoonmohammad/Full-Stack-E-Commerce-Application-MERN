...
const CreateCategory = () => {
    ...
    const handlesubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post("https://impossible-ray-headscarf.cyclic.app/categories/create-category", { name },
                {
                    headers: {
    ...
    const getAllCategories = async () => {
        try {
            const response = await axios("https://impossible-ray-headscarf.cyclic.app/categories/get-category")
            if (response.data.success) {
    ...
    const handleupdate = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.put(`https://impossible-ray-headscarf.cyclic.app/categories/update-category/${selected._id}`, { name: updatedname },
                {
                    headers: {
                        "Authorization": data.token
                    }
    ...
    const handledelete = async (id) => {
        try {
            const response = await axios.delete(`https://impossible-ray-headscarf.cyclic.app/categories/delete-category/${id}`,
                {
                    headers: {
                        "Authorization": data.token
                    }
