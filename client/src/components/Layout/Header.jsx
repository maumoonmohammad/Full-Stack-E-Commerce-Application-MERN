                    ...
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                <Link className="nav-link dropdown-toggle" to={"https://impossible-ray-headscarf.cyclic.app/categories"} role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Categories
                                </Link>
